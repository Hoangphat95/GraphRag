...
from api.middleware import APIKeyAuthMiddleware, SimpleRateLimitMiddleware
app.add_middleware(APIKeyAuthMiddleware)
app.add_middleware(SimpleRateLimitMiddleware)

from infra.metrics_prometheus import init_metrics, metrics_response, request_counter
init_metrics()
