...
from app.pipeline.orchestrator_v3 import GraphRAGv3
...
def test_stress_conversation():
    ...
    """
    # Skip long-running integration stress test unless explicitly enabled
    if os.environ.get("RUN_STRESS") != "1":
        import pytest

        pytest.skip("Skipping stress conversation (set RUN_STRESS=1 to enable)")
